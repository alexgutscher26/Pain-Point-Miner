...
if (tables.length === 0) {
  for (const file of ["drizzle/0000_faithful_mimic.sql", "drizzle/0001_ai_usage.sql", "drizzle/0002_hnsw_index_tuning.sql", "drizzle/0003_pain_point_tags_gin_idx.sql", "drizzle/0004_create_dashboard_opportunity_mv.sql"]) {
