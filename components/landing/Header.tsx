    ...
    <header className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <span className="font-bold text-base sm:text-lg text-white tracking-tight">Pain-Point Miner</span>
        </Link>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <Button asChild className="bg-[#ff4500] hover:bg-[#e03d00] text-white rounded-md px-3 h-9 text-xs sm:text-sm sm:px-4 font-medium shadow-none transition-all hidden md:flex">
