    ...
    <section className="w-full pt-32 pb-24 px-6 flex flex-col items-center bg-[#000]">
      <div className="text-center max-w-4xl mb-12">
        ...
        <p className="text-[17px] md:text-[19px] text-zinc-400 mt-4 leading-relaxed font-medium mx-auto max-w-[700px]">
          Reddit contains authentic conversations revealing exactly what people are struggling with. We help you mine it.
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-x-10 lg:gap-x-14 gap-y-8 mb-20 px-8 py-10 rounded-[24px] bg-linear-to-b from-[#1c0c0a] to-[#0f0504] border border-[#ff4500]/10 w-full max-w-[1020px] shadow-2xl">
        <div className="flex items-center gap-6 sm:pr-4">
          <div className="bg-transparent border border-[#ff4500]/20 rounded-xl shrink-0">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-[50px] h-[50px] text-[#ff4500] drop-shadow-[0_0_15px_rgba(255,69,0,0.5)]">
          ...
          <div className="flex flex-col items-start gap-1">
            <div className="text-[28px] md:text-[34px] lg:text-[36px] text-white font-extrabold leading-none tracking-tight">2B+</div>
            <span className="text-[13px] md:text-[14px] text-zinc-400 font-medium tracking-wide">monthly visits</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start gap-1 w-full sm:w-[200px] sm:pl-6">
          <div className="text-[28px] md:text-[34px] lg:text-[36px] text-white font-extrabold leading-none tracking-tight">100K+</div>
          <span className="text-[13px] md:text-[14px] text-zinc-400 font-medium tracking-wide">active communities</span>
        </div>
        <div className="w-px h-14 bg-white/[0.08] hidden sm:block"></div>
        <div className="flex flex-col items-start gap-1 w-full sm:w-[200px] sm:pl-6">
          <div className="text-[28px] md:text-[34px] lg:text-[36px] text-white font-extrabold leading-none tracking-tight">52M+</div>
          <span className="text-[13px] md:text-[14px] text-zinc-400 font-medium tracking-wide">daily active users</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl w-full mb-32">
        ...
        <div className="bg-[#0f0f0f] border-2 border-white/[0.03] rounded-[24px] p-8 relative overflow-hidden group hover:border-white/[0.08] transition-colors shadow-2xl">
          <div className="h-44 bg-black rounded-xl border-2 border-white/[0.03] mb-8 p-4 flex flex-col justify-center relative overflow-hidden shadow-inner">
             ...
             <div className="absolute right-4 bottom-4 bg-[#ff4500] px-3.5 py-2 rounded-full text-[11px] font-bold text-white flex items-center gap-1.5 shadow-[0_4px_15px_rgba(255,69,0,0.4)] translate-y-2 group-hover:translate-y-0 transition-transform uppercase tracking-wider">
                <Search className="w-3.5 h-3.5" strokeWidth={3}/> Problem identified
             </div>
          </div>
          <h3 className="font-extrabold text-[22px] text-white mb-3">Identify Frustrations</h3>
          <p className="text-[15px] text-zinc-400 leading-relaxed font-medium">Scan thousands of recent posts to automatically extract underlying problems and common complaints.</p>
        </div>
        ...
        <div className="bg-[#0f0f0f] border-2 border-white/[0.03] rounded-[24px] p-8 relative overflow-hidden group hover:border-white/[0.08] transition-colors shadow-2xl">
          ...
          <h3 className="font-extrabold text-[22px] text-white mb-3">Analyze User Language</h3>
          <p className="text-[15px] text-zinc-400 leading-relaxed font-medium">Organize insights into structured reports showing examples of the exact wording users use to describe issues.</p>
        </div>
             ...
             <div className="bg-[#1a1a1a] border border-white/[0.05] rounded-xl p-4 w-full relative z-10 transition-transform group-hover:-translate-y-2 duration-500 shadow-xl">
                 ...
                 <div className="flex justify-end">
                    <div className="bg-[#ff4500] text-white text-[11px] px-4 py-2 rounded-full flex items-center gap-1.5 font-bold shadow-[0_4px_15px_rgba(255,69,0,0.4)] uppercase tracking-wider">
                       <MessageSquare className="w-3.5 h-3.5" fill="currentColor"/> Report
                    </div>
                 </div>
             </div>
          </div>
          <h3 className="font-extrabold text-[22px] text-white mb-3">Prioritize with Data</h3>
          <p className="text-[15px] text-zinc-400 leading-relaxed font-medium">Surface the most significant problems with validation signals like upvotes, comment volume, and mentions.</p>
        </div>
      </div>
      ...
      <div className="max-w-[700px] w-full flex flex-col items-center">
          <div className="text-center mb-8">
             <h3 className="text-3xl md:text-[40px] font-extrabold text-white leading-tight">Continuous <span className="text-[#ff4500]">Idea Discovery</span></h3>
             <p className="text-zinc-400 text-base md:text-[18px] mt-4 font-medium">Turn Reddit into a structured research dataset for your SaaS.</p>
          </div>
          ...
          <div className="relative w-full rounded-[32px] p-10 md:p-14 flex flex-col items-center bg-[#0a0a0a] border border-white/[0.02] shadow-[inset_0_0_100px_rgba(255,69,0,0.03),0_20px_40px_rgba(0,0,0,0.5)]">
             ...
             <div className="flex flex-col items-center z-10 w-full max-w-[340px]">
                ...
                <p className="text-[11px] text-zinc-500 font-bold tracking-[0.2em] uppercase">🔥 No Credit Card Required</p>
             </div>
          </div>
      </div>
    </section>
