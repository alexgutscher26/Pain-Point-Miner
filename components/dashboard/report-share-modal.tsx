...
export function ReportShareModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] sm:max-w-lg border border-zinc-200 bg-white p-6 text-zinc-950 overflow-hidden">
        <DialogHeader>
          ...
          <div>
            ...
            <div className="mt-1.5 flex items-center gap-2 min-w-0">
              ...
              <button
                ...
                className="shrink-0 flex items-center gap-1 rounded-xl bg-zinc-900 px-3.5 py-2 text-xs font-bold text-white transition-colors hover:bg-zinc-700"
              >
                {copiedLink ? (
          ...
          <div className="border-zinc-150 border-t pt-4">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5 min-w-0">
                <Code2 className="h-4 w-4 text-[#ff4500] shrink-0" />
            ...
            {/* Code Snippet Box */}
            <div className="relative mt-3 rounded-xl border border-zinc-200 bg-zinc-900 p-3.5 text-white max-w-full overflow-hidden">
              <pre className="overflow-x-auto max-w-full whitespace-pre-wrap break-all pr-24 font-mono text-[11px] leading-relaxed text-zinc-300">
