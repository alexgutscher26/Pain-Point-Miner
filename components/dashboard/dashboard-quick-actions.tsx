      ...
      <div className="mt-4 grid grid-cols-1 gap-3.5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <ArrowRight className="h-4 w-4 text-[#ff4500] opacity-0 transition-all group-hover:translate-x-0.5 group-hover:opacity-100" />
          </div>
          <h5 className="mt-3 font-mono text-xs font-bold tracking-wider text-zinc-900 uppercase dark:text-white">
            Start Live Scan
          </h5>
        ...
        <Link
          href={
            latestReportId
              ? `/dashboard/reports/${latestReportId}`
              : "/dashboard/reports"
          }
