...
function CommunityPainPointCard({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200/60 bg-white p-5 shadow-xs">
      <div className="flex items-start justify-between gap-4">
        ...
        <div
          className="shrink-0 rounded-md border px-2 py-1 text-[10px] font-black tracking-widest uppercase"
          style={{
            color: tone.text,
      ...
      <div className="mt-4 flex items-center justify-between gap-4 border-t border-black/[0.03] pt-3">
        ...
        <Link
          ...
          className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-zinc-200 bg-white/60 px-3 py-2 font-mono text-[10px] font-black tracking-widest text-zinc-600 uppercase transition-all hover:border-[#ff4500] hover:bg-[#ff4500] hover:text-white"
        >
          Open report
...
export function CommunityMapPanel({
  ...
  return (
    <>
      <div className="animate-in fade-in overflow-hidden rounded-2xl border border-black/[0.05] bg-white/60 shadow-xs backdrop-blur-md duration-300">
        <div className="flex items-center justify-between gap-4 border-b border-black/[0.05] bg-black/[0.01] px-8 py-6">
          ...
          <div className="hidden items-center gap-2 rounded-full border border-black/[0.05] bg-black/[0.02] px-3.5 py-1.5 font-mono text-[10px] font-bold tracking-widest text-zinc-600 uppercase md:flex">
            <Flame className="h-3.5 w-3.5 animate-pulse text-[#ff4500]" />
            Color = avg intensity
          </div>
        </div>
        ...
        {nodes.length === 0 ? (
          <div className="flex min-h-[320px] flex-col items-center justify-center gap-4 px-6 py-12 text-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-black/[0.05] bg-black/[0.02] text-zinc-400">
          ...
          <>
              ...
              {nodes.map((node) => {
                ...
                return (
                  <button
                    ...
                    className={`${span.colSpan} ${span.rowSpan} group cursor-pointer rounded-2xl border p-5 text-left transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xs`}
                    style={{
                      borderColor: tone.border,
                      backgroundColor: tone.fillMuted,
                    }}
                  >
                    <div className="flex h-full flex-col justify-between">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span
                          className="rounded-full border px-2 py-0.5 font-mono text-[9px] font-black tracking-widest uppercase"
                          style={{
                      ...
                      <div className="flex items-end justify-between gap-3">
                        <div>
                          ...
                          <p className="text-zinc-450 font-mono text-[10px] font-bold tracking-widest uppercase">
                            avg intensity
                          </p>
                        </div>
            ...
            <div className="border-t border-black/[0.05] bg-black/[0.005] px-8 py-4">
      ...
      <Drawer
        ...
        direction="right"
      >
        <DrawerContent className="border-l border-zinc-200/50 bg-white/95 text-zinc-900 backdrop-blur-xl sm:max-w-xl">
          {selectedNode ? (
            <>
              ...
              <div className="space-y-4 overflow-y-auto bg-zinc-50/30 px-6 py-6">
