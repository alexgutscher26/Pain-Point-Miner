...
const nextConfig: NextConfig = {
  ...
  headers() {
    const cspDirectives = [
      ...
      "img-src 'self' blob: data: https://*.reddit.com https://*.redd.it https://images.unsplash.com https://b.thumbs.redditmedia.com https://i.redd.it https://*.stripe.com https://*.userjot.com https://api.producthunt.com https://www.producthunt.com",
