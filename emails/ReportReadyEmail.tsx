        ...
        <Body className="m-0 bg-[#f3f4f6] py-[48px]" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
          ...
          <Container className="mx-auto w-full max-w-[600px] overflow-hidden bg-white" style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.07)" }}>
            ...
            <Section className="px-[40px] pt-[40px] pb-[36px]">
              ...
              >
                Your scan uncovered <strong style={{ color: "#0f0f0f", fontStyle: "normal" }}>{painPointsFound}</strong> potential pain points and startup ideas.
              </Text>
            </Section>
                      ...
                      <td style={{ padding: "16px 20px" }}>
                        ...
                        <table width="100%" cellPadding="0" cellSpacing="0" style={{ borderCollapse: "collapse", marginBottom: "8px" }}>
                          <tr>
                            ...
                            <td align="right" style={{ verticalAlign: "top", paddingLeft: "12px", whiteSpace: "nowrap" }}>
                        ...
                        {/* Excerpt */}
                        <Text className="m-0 text-[13px] text-[#6b7280] leading-[21px]" style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontStyle: "italic" }}>
                          "{pp.excerpt.length > 120 ? pp.excerpt.substring(0, 120) + "..." : pp.excerpt}"
                        </Text>
                        {/* Score bar */}
                        <table width="100%" cellPadding="0" cellSpacing="0" style={{ borderCollapse: "collapse", marginTop: "12px" }}>
                          <tr>
                            <td style={{ backgroundColor: "#e5e7eb", borderRadius: "99px", height: "6px", overflow: "hidden" }}>
                              <table cellPadding="0" cellSpacing="0" style={{ borderCollapse: "collapse", height: "6px" }}>
                                <tr>
                                  <td style={{ backgroundColor: "#10b981", width: `${Math.min(100, (pp.score / 10) * 100)}%`, height: "6px", borderRadius: "99px" }} />
                                </tr>
                              </table>
                            </td>
                          </tr>
                ...
                <tr>
                  <td style={{ padding: "28px 24px", textAlign: "center" }}>
                    ...
                    <Text className="m-0 text-[18px] font-bold text-[#0f0f0f]" style={{ fontFamily: "Georgia, 'Times New Roman', serif", letterSpacing: "-0.3px", marginBottom: "20px" }}>
                      See the full breakdown, competitor gaps,<br />and feature ideas.
                    </Text>
                    <Button
                      href={reportUrl}
                      style={{
  ...
  topPainPoints: [
    {
      ...
      excerpt: "I am spending 40% of my time writing reducers and thunks just to implement a simple toggle button...",
      score: 8.5,
    },
    {
      title: "useEffect dependency arrays cause infinite loops",
      excerpt: "Why does React make it so hard to just fetch data on mount without getting warning logs or crashing the tab?",
      score: 7.2,
    },
  ],
