          ...
          >
                      ...
                      <td style={{ padding: "16px 20px" }}>
                        ...
                        >
                          <tr>
                            <td>
                              <Text
                                className="m-0 text-[10px] font-bold text-[#f97316]"
                                style={{
                                  fontFamily: "monospace",
                                  letterSpacing: "1.5px",
                                  textTransform: "uppercase",
                ...
                >
                  <tr>
                    <td style={{ padding: "24px", textAlign: "center" }}>
                      <Text
                        className="m-0 text-[14px] text-[#6b7280]"
                        style={{
                          fontFamily: "Georgia, 'Times New Roman', serif",
                          fontStyle: "italic",
                        }}
                      >
                        No high-scoring opportunities this week. Run a fresh
                        scan to surface more insights.
                      </Text>
                    </td>
                  </tr>
                </table>
            ...
            {trendingKeyword && (
              <Section className="px-[40px] pb-[8px]">
                <Hr
                  style={{ borderColor: "#e5e7eb", margin: "8px 0 24px 0" }}
                />
                <table
                  width="100%"
                  cellPadding="0"
                ...
                <Text
                  className="m-0 mt-[16px] text-[15px] leading-[26px] text-[#374151]"
                  style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}
                >
                  A surge in mentions for{" "}
                  <strong style={{ color: "#0f0f0f" }}>
                    "{trendingKeyword}"
                  </strong>{" "}
                  has been detected across your saved communities. Consider
              ...
              >
                <tr>
                  <td style={{ padding: "28px 24px", textAlign: "center" }}>
                    <Text
                      className="m-0 text-[10px] text-[#f97316]"
                      style={{
                        fontFamily: "monospace",
                        letterSpacing: "2px",
                        textTransform: "uppercase",
            ...
            >
              ...
              >
                ...
                or manage your{" "}
                <Link
                  href="https://threddiq.com/dashboard/settings"
                  style={{ color: "#0f0f0f", textDecoration: "underline" }}
                >
                  email preferences
                </Link>
...
WeeklyDigestEmail.PreviewProps = {
  ...
  topOpportunities: [
    {
      title:
        "Automated subreddit moderation for niche mental health communities",
      score: 9.2,
      niche: "SaaS",
    },
    {
      title: "Real-time pricing alerts for collectible mechanical keyboards",
      score: 8.4,
      niche: "MechanicalKeyboards",
    },
    {
      title: "AI-driven sentiment analysis for developer relations on Discord",
      score: 7.9,
      niche: "webdev",
    },
  ],
