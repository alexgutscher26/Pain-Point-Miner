        ...
        <Body className="m-0 bg-[#f3f4f6] py-[48px]" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
          ...
          <Container className="mx-auto w-full max-w-[600px] overflow-hidden bg-white" style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.07)" }}>
            ...
            <Section className="px-[40px] pt-[40px] pb-[36px]">
              ...
              >
                Turn complaints<br />into companies.
              </Heading>
              <Text
            ...
            <Section className="px-[40px] pt-[32px] pb-[0px]">
              <Text className="m-0 text-[15px] text-[#374151] leading-[26px]" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
                We built ThreddIQ because the best startup ideas aren't invented — they're discovered buried in subreddits, forums, and comment threads. Our AI surfaces those frustrations so you can build exactly what people are asking for.
              </Text>
            </Section>
            ...
            <Section className="px-[40px] pt-[24px] pb-[8px]">
              {[
                { num: "01", title: "Choose a Community", body: "Pick a subreddit or niche where your target audience vents, asks, and shares frustrations daily." },
                { num: "02", title: "Let the Miner Run", body: "Our AI scans hundreds of posts and comments, clustering recurring pain points by theme and intensity." },
                { num: "03", title: "Build with Confidence", body: "Receive a full report: validated problems, competitor gaps, feature ideas, and audience language — ready to act on." },
              ].map((step) => (
                <table key={step.num} width="100%" cellPadding="0" cellSpacing="0" style={{ marginBottom: "24px", borderCollapse: "collapse" }}>
                  <tr>
                    <td valign="top" style={{ width: "44px", paddingTop: "2px", paddingRight: "16px" }}>
                      <Text className="m-0 text-[13px] font-bold text-[#f97316]" style={{ fontFamily: "monospace", letterSpacing: "1px" }}>
                        {step.num}
                      </Text>
                    </td>
                    <td valign="top" style={{ borderLeft: "2px solid #f3f4f6", paddingLeft: "16px" }}>
                      <Text className="m-0 text-[15px] font-bold text-[#0f0f0f]" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
                        {step.title}
                      </Text>
                      <Text className="m-0 mt-[4px] text-[14px] text-[#6b7280] leading-[22px]" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
                        {step.body}
                      </Text>
                    </td>
                  </tr>
            ...
            <Section className="px-[40px] py-[28px]" style={{ backgroundColor: "#f9fafb", borderTop: "1px solid #e5e7eb" }}>
              ...
              <Text className="m-0 mt-[12px] text-[13px] text-[#6b7280] leading-[20px]" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
                ...
                <Link href="#" style={{ color: "#0f0f0f", textDecoration: "underline" }}>Unsubscribe</Link>
              </Text>
            </Section>
