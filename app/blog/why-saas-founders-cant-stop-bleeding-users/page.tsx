    ...
    <div className="min-h-screen landing-gradient font-sans text-zinc-800 selection:bg-[#ff4500]/10 selection:text-[#ff4500]">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col px-6 pt-32 pb-24">
        ...
        <div className="mb-12 flex items-center gap-3 text-xs font-bold tracking-widest text-zinc-500 uppercase">
          ...
          <Link href="/resources/best-subreddits-by-industry" className="transition-colors hover:text-zinc-900">
            Resources
          </Link>
          <span className="text-zinc-300">/</span>
        ...
        <section className="mb-24">
          <h2 className="mb-10 text-3xl font-black text-zinc-900 md:text-4xl">The five frustrations</h2>
            ...
            <div key={i} className="flex flex-col gap-10 md:flex-row md:items-start">
              ...
              <div className="flex-1">
                <div className="mb-4 flex items-center gap-4">
                  <h3 className="text-2xl font-black text-zinc-900 md:text-3xl">{i + 1}. {item.title}</h3>
        ...
        {/* Quote */}
        <div className="mb-32 border-l-4 border-[#ff4500] glass-card py-12 px-10 rounded-r-[32px]">
        ...
        <section className="mb-32 grid gap-16 md:grid-cols-2">
          <div>
            <h2 className="mb-8 text-3xl font-black text-zinc-900">What the signals are really saying</h2>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={signal} className="flex items-center gap-3 rounded-2xl glass-card p-4 text-[13px] font-bold text-zinc-700">
          ...
          <div className="rounded-[40px] glass-card p-10 flex flex-col justify-center">
             <p className="text-lg font-medium text-zinc-600 leading-relaxed italic md:text-xl">
        ...
        <section className="mb-32 rounded-[48px] border border-[#ff4500]/10 bg-linear-to-b from-[#ff4500]/5 to-[#f59e0b]/5 p-12 md:p-20">
          <div className="max-w-3xl">
            <h2 className="mb-8 text-3xl font-black text-zinc-900 md:text-5xl">The B2B pricing trap</h2>
            <p className="mb-8 text-xl font-medium text-zinc-600 leading-relaxed md:text-2xl">
            ...
            <p className="text-lg font-medium text-zinc-500 leading-relaxed md:text-xl">
              ...
              <br /><br />
              Our analysis found <span className="text-zinc-900 font-black">$200 ACV</span> and <span className="text-zinc-900 font-black">$2,000 ACV</span> behavior diverging sharply. High-user accounts with many products locked into annual contracts require dedicated sales—yet most SaaS tooling treats them the same as a single-seat starter.
            </p>
          </div>
        </section>
        ...
        <section className="mb-32">
          <h2 className="mb-12 text-3xl font-black text-zinc-900 md:text-5xl text-center">What to do about it</h2>
          <div className="grid gap-6 md:grid-cols-2">
             {[
               ...
               <div key={i} className="group relative overflow-hidden rounded-[32px] glass-card p-10 transition-all">
                 <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-[#ff4500]/10 text-[#ff4500]">
                   <CheckCircle2 className="h-6 w-6" />
                 </div>
                 <h4 className="mb-4 text-xl font-black text-zinc-900">{task.title}</h4>
