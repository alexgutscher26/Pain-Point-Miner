...
export const metadata: Metadata = {
  ...
  description:
    "We ran our SaaS churn dataset through a structured frustration analysis—737 pieces of customer feedback, distilled into the top five reasons users actually leave.",
};
    ...
    <div className="landing-gradient min-h-screen font-sans text-zinc-800 selection:bg-[#ff4500]/10 selection:text-[#ff4500]">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col px-6 pt-32 pb-24">
        ...
        <div className="mb-12 flex items-center gap-3 text-xs font-bold tracking-widest text-zinc-500 uppercase">
          ...
          <span className="text-zinc-300">/</span>
          <span className="text-zinc-900">Churn Analysis</span>
        </div>
        ...
        <header className="mb-20">
          <h1 className="mb-8 text-[40px] leading-tight font-black tracking-tight text-zinc-900 md:text-[72px]">
            ...
            can&apos;t stop{" "}
            <span className="text-[#ff4500]">bleeding users</span>
          </h1>
          <p className="max-w-3xl text-xl leading-relaxed font-medium text-zinc-500 md:text-2xl">
            We ran our SaaS churn dataset through a structured frustration
            analysis—737 pieces of customer feedback, distilled into the top
            five reasons users actually leave. The findings are blunt. And most
            of them are fixable.
          </p>
        </header>
        ...
        <section className="mb-24">
          ...
          <p className="max-w-3xl text-xl leading-relaxed font-medium text-zinc-500">
            Every frustration in our analysis scored a 7 out of 10 on
            severity—not catastrophic, but consistently painful. That&apos;s
            actually more dangerous than a single 10/10 crisis. These are the
            slow bleeds.
          </p>
        </section>
        ...
        <section className="mb-32 space-y-12">
          {frustrations.map((item, i) => (
            ...
            >
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-black/10 bg-black/5 text-zinc-800">
                {item.icon}
              </div>
              <div className="flex-1">
                <div className="mb-4 flex items-center gap-4">
                  <h3 className="text-2xl font-black text-zinc-900 md:text-3xl">
                    {i + 1}. {item.title}
                  </h3>
                  <span className="flex items-center gap-1.5 rounded-full border border-red-500/20 bg-red-500/10 px-3 py-1 text-xs font-black tracking-wider text-red-500 uppercase">
        ...
        {/* Quote */}
        <div className="glass-card mb-32 rounded-r-[32px] border-l-4 border-[#ff4500] px-10 py-12">
          <blockquote className="text-3xl leading-tight font-black text-zinc-900 italic md:text-4xl">
            &ldquo;They only ask us to go. We only count the ways we made it
            hard for them to leave.&rdquo;
          </blockquote>
        </div>
        ...
        <section className="mb-32 grid gap-16 md:grid-cols-2">
          <div>
            ...
            <p className="mb-10 text-lg leading-relaxed font-medium text-zinc-500 md:text-xl">
              Across all five frustrations, three underlying signals repeat
              themselves. Customers have high willingness to pay—they&apos;re
              not leaving because SaaS is too expensive. They&apos;re leaving
              because the experience doesn&apos;t justify the cost.
            </p>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {[
                ...
                <div
                  key={signal}
                  className="glass-card flex items-center gap-3 rounded-2xl p-4 text-[13px] font-bold text-zinc-700"
                >
          ...
          <div className="glass-card flex flex-col justify-center rounded-[40px] p-10">
            <p className="text-lg leading-relaxed font-medium text-zinc-600 italic md:text-xl">
              &ldquo;The market isn&apos;t lacking demand. It&apos;s lacking
              products that grow with their customers. The founders who win are
              the ones who price for the customer they want, build flexibility
              in from day one, and make it embarrassingly easy to cancel—because
              customers who leave cleanly often come back.&rdquo;
            </p>
          </div>
        </section>

        {/* Pricing Trap */}
        <section className="mb-32 rounded-[48px] border border-[#ff4500]/10 bg-linear-to-b from-[#ff4500]/5 to-[#f59e0b]/5 p-12 md:p-20">
          <div className="max-w-3xl">
            <h2 className="mb-8 text-3xl font-black text-zinc-900 md:text-5xl">
              The B2B pricing trap
            </h2>
            <p className="mb-8 text-xl leading-relaxed font-medium text-zinc-600 md:text-2xl">
              Frustrations three and four are deeply linked. When you price at
              $200/month, you attract buyers with $200/month expectations. Those
              buyers then request features that would only make sense at
              $2,000/month.
            </p>
            <p className="text-lg leading-relaxed font-medium text-zinc-500 md:text-xl">
              Your roadmap gets pulled in a direction that serves the wrong
              segment—and your best-fit customers churn because the product
              ...
              <span className="font-black text-zinc-900">$2,000 ACV</span>{" "}
              behavior diverging sharply. High-user accounts with many products
              locked into annual contracts require dedicated sales—yet most SaaS
              tooling treats them the same as a single-seat starter.
            </p>
          </div>
        </section>
        ...
        <section className="mb-32">
          <h2 className="mb-12 text-center text-3xl font-black text-zinc-900 md:text-5xl">
            What to do about it
          </h2>
          <div className="grid gap-6 md:grid-cols-2">
            {[
              {
                title: "Price for your ideal customer",
                desc: "Not your easiest customer. High-intent users deserve premium attention.",
              },
              {
                title: "Build a compliance layer",
                desc: "Cold outreach tooling needs built-in GDPR/CAN-SPAM safety by default.",
              },
              {
                title: "Audit your cancellation flow",
                desc: "Like a regulator would. Then fix it. Transparency builds long-term trust.",
              },
              {
                title: "Offer configurability",
                desc: "Focus on the contract level, not just the settings level. Workflows must adapt.",
              },
              {
                title: "Separate your pipelines",
                desc: "Enterprise and SMB tracks need different tooling and different focus levels.",
              },
            ].map((task, i) => (
              <div
                key={i}
                className="group glass-card relative overflow-hidden rounded-[32px] p-10 transition-all"
              >
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-[#ff4500]/10 text-[#ff4500]">
                  <CheckCircle2 className="h-6 w-6" />
                </div>
                <h4 className="mb-4 text-xl font-black text-zinc-900">
                  {task.title}
                </h4>
        ...
        <section className="mb-32 border-t border-black/10 py-16 text-center">
          <p className="mx-auto max-w-2xl text-xl leading-relaxed font-medium text-zinc-500 italic md:text-2xl">
            Churn isn&apos;t a product problem or a pricing problem in
            isolation. It&apos;s a fit problem. The companies that solve it
            aren&apos;t the ones with the most features—they're the ones who
            made every friction point feel intentional rather than accidental.
          </p>
          <div className="mt-12 text-xs font-bold tracking-widest text-zinc-500 uppercase">
            Analysis sourced from Thematic SaaS Churn research. 737 customer
            signals reviewed.
          </div>
        </section>
        ...
        <div className="glass-card relative mt-24 flex flex-col items-center overflow-hidden rounded-[48px] p-16">
          ...
          <h2 className="mb-6 text-center text-3xl font-extrabold text-zinc-900 md:text-5xl">
            Find your high-intent{" "}
            <span className="text-[#ff4500]">opportunities</span>
          </h2>
          <p className="mb-12 max-w-2xl text-center text-xl leading-relaxed font-medium text-zinc-500">
            Stop guessing what customers want. Use ThreddIQ to mine Reddit for
            real-world pain points and build a product that retains users.
          </p>
