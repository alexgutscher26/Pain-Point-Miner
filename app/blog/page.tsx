...
export const metadata: Metadata = constructMetadata({
  title: `Blog & Research - ${siteConfig.name}`,
  description:
    "Data studies, market research, and guides for SaaS founders discovering customer pain points and validating ideas on Reddit.",
  path: "/blog",
  ogImage: `${siteUrl}/api/og?title=Blog+%26+Founder+Research&description=Data+studies%2C+pain+point+linguistics%2C+and+SaaS+validation+guides&badge=Research&category=ThreddIQ+Blog`,
});
...
const blogPosts = [
  {
    ...
    description:
      "A data-backed comparison of three validation methods — and why Reddit is the most underrated signal source for predicting revenue.",
  ...
  },
  {
    ...
    description:
      "The contrarian take: most founders confuse market demand with competitive readiness. Here's why validated ideas fail and how to spot the difference.",
  ...
  },
  {
    ...
    description:
      "Learn how to mine Reddit for real pain points, budget signals, and market demand — a step-by-step guide to systematic customer research.",
  ...
  {
    title:
      "We Analyzed 10,000 Reddit Complaints — Here's What SaaS Founders Are Actually Building",
    subtitle: "Data across 200+ subreddits",
    description:
      "After parsing 10,000 complaints, we found the five categories where founder attention clusters — and the one nobody's building for.",
  ...
  },
  {
    ...
    description:
      "A monthly breakdown of the single most frequently voiced software problem across founder and operator communities.",
  ...
  {
    title:
      "7 Subtle Phrases People Say on Reddit Right Before 'I'd Pay For This'",
    subtitle: "Hidden intent markers in everyday discussions",
    description:
      "The verbal patterns that indicate extreme buyer frustration and readiness to switch software before explicit budget talk happens.",
  ...
  },
  {
    ...
    description:
      "Why engineers abandon infrastructure tools and the product and pricing mistakes that drive technical churn.",
  ...
  },
  {
    ...
    description:
      "How community perception of simple wrappers plummeted and what differentiated AI architectures users willingly pay $50+/mo for.",
  ...
  },
  {
    ...
    description:
      "A playbook for finding niche business software ideas in professional subreddits with low maintenance and zero VC competition.",
  ...
  },
  {
    ...
    description:
      "Why product teams are augmenting customer discovery calls with automated semantic mining across developer and founder communities.",
  ...
  },
  {
    ...
    description:
      "A deep dive into 737 customer signals to uncover the top five reasons SaaS users actually leave — and what to do about it.",
  ...
  {
    title:
      "How to Set Up Real-Time Slack Alerts So You Never Miss a Hot Pain Point",
    subtitle: "Real-time Reddit monitoring for your ICP",
    description:
      "A step-by-step guide to configuring real-time Slack alerts so you never miss a high-signal complaint the moment it drops.",
  ...
  {
    title:
      "Reading a Desperation Score: What Actually Makes a Complaint 'Validated'",
    subtitle: "Venting vs. validated demand — a scoring framework",
    description:
      "A repeatable framework for scoring Reddit complaints by urgency, specificity, and budget intent — the methodology behind ThreddIQ's Desperation Score.",
  ...
  {
    title:
      "How to Track a Competitor's Complaints on Reddit and Turn Them Into Your Roadmap",
    subtitle: "Competitor intelligence from organic Reddit data",
    description:
      "Learn how to monitor competitor criticism on Reddit and turn customer frustration into your product roadmap — without scraping or manual searching.",
  ...
  },
  {
    ...
    description:
      "A repeatable workflow that takes you from a raw Reddit thread to a structured Notion doc — capturing the pain point, quote, context, and market signal in under 10 minutes.",
  ...
  },
  {
    ...
    description:
      "A ranked guide to the six best subreddits for B2B SaaS idea validation — scored by desperation signal density, budget mention frequency, and purchase intent.",
  ...
  {
    title:
      "Where Marketers Complain Online, and What It Means If You're Building for Them",
    subtitle: "Top subreddits for marketing tool pain points",
    description:
      "The six highest-signal subreddits for marketing tool complaints — and the three complaint archetypes that reveal exactly what to build next.",
  ...
  },
  {
    ...
    description:
      "The top subreddits for fintech and billing tool validation — ranked by signal quality, with the five most common billing pain points showing up right now.",
  ...
  },
  {
    ...
    description:
      "The top subreddits where freelancers and agencies complain about project management, CRM, invoicing, and collaboration tools — and why they're your best early customers.",
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col px-6 pt-32 pb-24">
        <header className="mb-20 text-center">
          ...
          <p className="mx-auto max-w-2xl text-xl font-medium text-zinc-600">
            Research-backed insights, data studies, and practical guides for
            founders who want to build software with validated market demand.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post) => (
            <Link
              key={post.href}
              href={post.href}
              className="group glass-card relative flex flex-col overflow-hidden rounded-[32px] p-8 transition-all hover:border-[#ff4500]/30 hover:shadow-lg"
            >
              ...
              <p className="mb-8 flex-1 text-sm leading-relaxed font-medium text-zinc-600">
                {post.description}
              </p>

              <div className="flex items-center justify-between border-t border-black/5 pt-4">
                <span className="text-[11px] font-bold tracking-widest text-zinc-600 uppercase">
                  {post.date}
                </span>
                <div className="flex items-center gap-2 text-xs font-black tracking-widest text-zinc-600 uppercase transition-colors group-hover:text-zinc-900">
                  Read Post{" "}
