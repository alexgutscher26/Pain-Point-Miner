...
export const metadata: Metadata = {
  title:
    "How to Set Up Real-Time Slack Alerts for Reddit Pain Points | ThreddIQ Blog",
  description:
    "Step-by-step guide to configuring ThreddIQ Slack alerts so you never miss a hot pain point — filter by keyword, subreddit, desperation score, and budget signal.",
};
...
const alertExample = [
  ...
  {
    label: "Pain Point",
    value: '"Every analytics tool is overkill for what we need"',
  },
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col px-6 pt-32 pb-24">
        ...
        <header className="mb-20">
          ...
          <p className="max-w-3xl text-xl leading-relaxed font-medium text-zinc-500 md:text-2xl">
            Hot pain points don't wait for your morning scan. A thread with a
            9/10 desperation score and a &ldquo;I&apos;d pay $200/month&rdquo;
            mention is a customer knocking. Here&apos;s how to route that signal
            straight to your team&apos;s Slack in under 5 minutes.
          </p>
        </header>
        ...
        <section className="mb-24">
          ...
          <p className="mb-10 text-lg leading-relaxed font-medium text-zinc-500 md:text-xl">
            By the end of this tutorial, you&apos;ll have a live Slack
            integration that pushes high-quality Reddit pain points to a channel
            of your choice — filtered by relevance, scored by desperation, and
            enriched with budget signals. Here&apos;s the full setup:
          </p>
        ...
        <section className="glass-card mb-32 rounded-[48px] p-12 md:p-20">
          ...
          <p className="mb-8 text-lg font-medium text-zinc-500">
            Every ThreddIQ Slack alert includes:
          </p>
          <div className="space-y-4">
            {alertExample.map((item, i) => (
              ...
              >
                <span className="min-w-[160px] text-xs font-black tracking-widest text-zinc-600 uppercase">
                  {item.label}
                </span>
        ...
        <section className="mb-32">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              {
                title: "Separate channels per product",
                desc: "If you're tracking multiple niches, create one Slack channel per product line. #signals-analytics, #signals-devops, #signals-sales — each with its own keyword filter.",
              },
              {
                title: "Escalate by score range",
                desc: "Route 9–10 desperation scores to a private #hot-leads channel. Route 6–8 to #pain-points for team discussion. Below 6, let them accumulate in your dashboard digest.",
              },
              {
                title: "Add competitor names as keywords",
                desc: "Include your top 3 competitors in your keyword groups. Every time a user complains about them, you get an alert. It's the cheapest competitive research you'll ever run.",
              },
              {
                title: "Share alerts with your whole team",
                desc: "Product, sales, and support all benefit from real-time Reddit signals. Product learns what to build. Sales learns who's shopping. Support learns what's broken.",
              },
            ].map((tip, i) => (
        ...
        <section className="glass-card mb-32 rounded-r-[32px] border-l-4 border-[#ff4500] px-10 py-12">
          <blockquote className="text-3xl leading-tight font-black text-zinc-900 italic md:text-4xl">
            &ldquo;The best time to respond to a pain point is the minute
            it&apos;s posted. By hour 6, the thread has 200 comments and the OP
            has already moved on. Slack alerts cut your response time from hours
            to seconds.&rdquo;
          </blockquote>
        </section>
        ...
        <section className="mb-32 border-t border-black/10 py-16 text-center">
          <p className="mx-auto max-w-2xl text-xl leading-relaxed font-medium text-zinc-500 italic md:text-2xl">
            Slack alerts turn Reddit from a place you check once a week into a
            real-time customer research feed. Once you&apos;ve felt the rush of
            catching a 9/10 desperation score 10 minutes after it&apos;s posted,
            you&apos;ll never go back to manual scanning.
          </p>
        </section>
        ...
        <div className="glass-card relative mt-24 flex flex-col items-center overflow-hidden rounded-[48px] p-16">
          ...
          <h2 className="mb-6 text-center text-3xl font-extrabold text-zinc-900 md:text-5xl">
            Get alerts in <span className="text-[#ff4500]">5 minutes</span>
          </h2>
          <p className="mb-12 max-w-2xl text-center text-xl leading-relaxed font-medium text-zinc-500">
            Connect Slack, set your filters, and start receiving real-time pain
            point alerts. No credit card required.
          </p>
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              <Link href="/sign-up">
                Set Up Slack Alerts <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
