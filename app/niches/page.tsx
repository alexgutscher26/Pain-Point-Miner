...
import { Sparkles, ArrowRight, Flame, Search, Lightbulb } from "lucide-react";
      ...
      <main className="pt-28 pb-20">
        ...
        <section className="mx-auto max-w-6xl px-4 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-zinc-600 sm:text-lg">
            Real customer pain points, extracted from thousands of Reddit
            threads across active subreddits. Browse validated problems with
            willingness-to-pay signals for free.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link href="/free-tools/pain-point-miner">
              <Button
                variant="outline"
                className="rounded-full border-zinc-300 bg-white px-6 py-5 font-medium text-zinc-800 hover:bg-zinc-50"
              >
                Try Free Micro-Tool
              </Button>
            </Link>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    {/* Scores Bar */}
                    <div className="mt-5 grid grid-cols-3 gap-2 rounded-xl border border-zinc-100 bg-zinc-50 p-3 text-center">
                      <div>
                    ...
                    {niche.topPainPoints[0] && (
                      <div className="mt-4 rounded-lg border border-orange-100 bg-orange-50/50 p-3">
                        ...
                        <p className="mt-1 line-clamp-2 text-xs font-medium text-orange-950">
