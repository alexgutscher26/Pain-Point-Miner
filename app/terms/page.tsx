...
export const metadata: Metadata = {
  ...
  description:
    "By using ThreddIQ, you agree to these Terms and Conditions. Please review them carefully.",
};
      ...
      <main className="container mx-auto max-w-4xl px-6 pt-32 pb-24">
        ...
        <div className="prose max-w-none space-y-8 text-[15px] leading-relaxed text-zinc-600">
          <section>
            ...
            <p>
              By accessing or using ThreddIQ, you agree to be bound by these
          ...
          <section>
            ...
            <p>
              You must be at least 18 years old to use ThreddIQ. You agree to
              use the service only for lawful purposes and in accordance with
              these Terms. Unauthorized use of our service may result in
          ...
          <section>
            ...
            <p>
              ThreddIQ offers both free and paid services. For paid
              subscriptions, billing is handled through Stripe. Fees are
              non-refundable except where required by law. We reserve the right
              to change our fees upon notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              are and will remain the exclusive property of ThreddIQ. Our
              trademarks and trade dress may not be used without our prior
              written consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Your use of ThreddIQ is also governed by our Privacy Policy. By
          ...
          <section>
            ...
            <p>
              In no event shall ThreddIQ, its directors, employees, or partners,
