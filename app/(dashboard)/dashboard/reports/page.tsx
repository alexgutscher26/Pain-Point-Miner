            ...
            <table className="w-full table-fixed text-left border-collapse">
              <thead>
                <tr className="border-b border-white/5 bg-white/2">
                  ...
                  <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 text-right">
                    Actions
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex min-w-0 items-center gap-4">
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center border border-white/5 shadow-inner bg-[#ff4500]/5 text-[#ff4500]`}
                        >
                    ...
                    <td className="px-8 py-6">
                      <div
                        className={`inline-flex items-center px-2.5 py-1 rounded-lg border text-[12px] font-black tracking-tighter ${
                          report.score >= 90
