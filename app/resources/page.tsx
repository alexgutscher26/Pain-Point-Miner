...
export const metadata: Metadata = {
  ...
  description:
    "Guides, tools, and research to help SaaS founders find and validate market opportunities.",
};
...
const resourceCards = [
  {
    ...
    description:
      "A deep dive into 737 customer signals to uncover the top five reasons for SaaS churn.",
  ...
  },
  {
    ...
    description:
      "A comprehensive guide to the most active subreddits for every business sector.",
  ...
  },
  {
    ...
    description:
      "How ThreddIQ compares against manual searching and traditional social listening.",
  ...
  },
  {
    ...
    description:
      "The definitive browser extensions and analytics platforms for every Reddit professional.",
  ...
  },
  {
    ...
    description:
      "Learn the specific keywords and patterns to monitor within your niche.",
  ...
  },
  {
    ...
    description:
      "Discover how founders use Reddit data for validation and competitor analysis.",
  ...
  },
  {
    ...
    description:
      "Strategic advice on how to market authentically in specific communities.",
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col px-6 pt-32 pb-24">
        <header className="mb-20 text-center">
          ...
          <p className="mx-auto max-w-2xl text-xl font-medium text-zinc-400">
            Guides, research, and analysis to help you cut through the noise and
            find what customers are actually begging for.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {resourceCards.map((card) => (
            ...
            >
              ...
              <p className="mb-8 flex-1 text-sm leading-relaxed font-medium text-zinc-500">
                {card.description}
              </p>

              <div className="flex items-center gap-2 text-xs font-black tracking-widest text-zinc-400 uppercase transition-colors group-hover:text-white">
                Read Resource{" "}
