...
export default async function OnboardingLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col landing-gradient text-zinc-900 antialiased selection:bg-[#ff4500]/10 selection:text-[#ff4500]">
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 pt-24 pb-12 sm:px-8 sm:pt-28">
        <div className="w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
          <Suspense fallback={<div className="h-40 w-full animate-pulse rounded-[24px] bg-zinc-200/50" />}>
            {children}
          </Suspense>
        </div>
      </main>
