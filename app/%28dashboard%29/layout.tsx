          ...
          <div className="relative mb-4 overflow-hidden rounded-2xl border border-zinc-200/90 bg-zinc-50/90 p-4 shadow-2xs backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/70">
            ...
            <div className="relative z-10 mb-3">
              <div className="mb-1 flex items-end justify-between font-mono">
                <p className="text-[10px] font-medium text-zinc-400">Monthly Scans</p>
                <p className="text-[11px] font-bold text-zinc-800 dark:text-zinc-200">
                  ...
                  {monthlyScansLimit === null ? (
                    ...
                    <span className="ml-1 text-zinc-400">/ {monthlyScansLimit}</span>
                  )}
                </p>
              </div>
            ...
            <Link
              ...
              className="relative z-10 block w-full rounded-xl bg-white border border-zinc-200/80 py-1.5 text-center font-mono text-[10px] font-bold tracking-wider text-zinc-800 uppercase shadow-2xs transition-all hover:bg-zinc-50 hover:border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
            >
              Manage Allocation
            </Link>
          </div>
        ...
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-zinc-200/90 bg-white/70 px-4 backdrop-blur-md sm:px-6 lg:px-8 dark:border-zinc-800 dark:bg-zinc-900/70">
          <div className="flex items-center gap-4">
            <DashboardMobileNav
              ...
              planLabel={planLabel}
            />
            <div className="flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 font-mono text-[10px] font-bold tracking-wide text-emerald-700 uppercase dark:text-emerald-400 max-sm:hidden">
