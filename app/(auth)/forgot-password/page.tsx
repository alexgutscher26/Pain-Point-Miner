  ...
  return (
    <div className="flex min-h-screen w-full overflow-hidden bg-black font-sans text-white antialiased">
      <AuthHero
        ...
        title={
          <>
            Secure your <span className="text-[#ff4500]">insights.</span>
          </>
        }
        subtitle="Don't worry, even the best miners lose their way sometimes. We'll get you back to uncovering those pain points in no time."
        insightProps={{
          badge: "Security Tip",
          ...
          {success ? (
            <div className="flex flex-col items-center text-center">
              ...
              <AuthFormHeader
                ...
                subtitle={`We've sent a password reset link to ${email}. If it doesn't arrive soon, check your spam folder.`}
              />
              <Link
            ...
            <>
              <AuthFormHeader
                ...
                subtitle="No problem. Enter your email and we'll send you a link to reset it."
              />
